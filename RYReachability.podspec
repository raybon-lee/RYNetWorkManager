...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/pengleelove"
  ...
  # Or just: s.author    = "bfforeverli"
  # s.authors            = { "bfforeverli" => "lipengios@163.com" }
  # s.social_media_url   = "http://twitter.com/bfforeverli"
 ...
 #  s.osx.deployment_target = "10.7"
  ...
  # s.frameworks = "CoreTelephony", "AnotherFramework"
